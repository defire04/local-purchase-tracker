...
const LANG_EN = {
  ...
  addCatBtn: 'Add',
  saveCatBtn: 'Save',
  hideCatBtn: 'Hide this category\'s items from the list',
  showCatBtn: 'Show this category\'s items in the list',
  hiddenTag: 'hidden',
  amountsShowBtn: 'Show amounts',
  amountsHideBtn: 'Hide amounts',
